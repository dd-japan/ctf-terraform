...
| <a name="input_ctfd_instance_name"></a> [ctfd\_instance\_name](#input\_ctfd\_instance\_name) | The name of the CTFD Japan Cloud SQL instance | `string` | `"ctfd-japan2"` | no |
...
| <a name="input_enabled_services"></a> [enabled\_services](#input\_enabled\_services) | n/a | <pre>map(list(object({<br/>    log_type         = string<br/>    exempted_members = optional(list(string))<br/>  })))</pre> | <pre>{<br/>  "compute.googleapis.com": [<br/>    {<br/>      "log_type": "ADMIN_READ"<br/>    }<br/>  ],<br/>  "sqladmin.googleapis.com": [<br/>    {<br/>      "log_type": "ADMIN_READ"<br/>    }<br/>  ],<br/>  "storage.googleapis.com": [<br/>    {<br/>      "log_type": "DATA_READ"<br/>    },<br/>    {<br/>      "log_type": "DATA_WRITE"<br/>    },<br/>    {<br/>      "log_type": "ADMIN_READ"<br/>    }<br/>  ]<br/>}</pre> | no |
